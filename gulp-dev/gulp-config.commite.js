...
module.exports = {
	...
	html: {
		...
		pages: [vars.source  + 'pages/**/*.html',vars.source  + 'Ministrypgaes/**/*.html'],
		watch   : [vars.source + 'templates/**/*.html', vars.source + 'pages/**/*.html',vars.source  + 'Ministrypgaes/**/*.html'],
