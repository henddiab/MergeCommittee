...
(function () {
    var dateHijri = new Intl.DateTimeFormat('ar-TN-u-ca-islamic', { day: 'numeric', month: 'long', weekday: 'long', year: 'numeric' }).format(Date.now());
    $('#hijri').html(dateHijri);

    var dateMeladi=new Date();
    var options = {year: 'numeric', month: 'long', day: 'numeric' };
    var dateMeladi2 = new Intl.DateTimeFormat('ar-US', options).format(dateMeladi);
    $('#meladi').html(dateMeladi2);
})();
// duration spinner
$('.hhmmss').timespinner({
    format: 'HH:mm:ss',
