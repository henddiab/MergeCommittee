...
(function(N, K) {
        ...
        l(I.prototype, {
            ...
            buildText: function(a) {
                ...
                if (M !== a.textCache) {
                    ...
                    x || E || r || g || -1 !== b.indexOf(" ") ? (l && l.appendChild(h), x ? (b = c.styledMode ? b.replace(/<(b|strong)>/g, '\x3cspan class\x3d"highcharts-strong"\x3e').replace(/<(i|em)>/g, '\x3cspan class\x3d"highcharts-emphasized"\x3e') : b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:500"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e'),
                ...
                d.slice(0, g.length + 1).forEach(function(a, n) {
                    if (!1 !== a && "" !== a) {
                        ...
                        z || (z = {
                            padding: c.padding,
                            r: c.borderRadius
                        }, l.styledMode || (z.fill = c.backgroundColor, z.stroke = c.borderColor || n.color || A.color || "var(--blackColor)", z["stroke-width"] = c.borderWidth), d.tt = z = b.label(null, null, null, (n.isHeader ? c.headerShape : c.shape) || "callout", null, null, c.useHTML).addClass("highcharts-tooltip-box " + D).attr(z).add(k));
                        z.isActive = !0;
                        z.attr({
                            text: a
                        });
    ...
    K(F, "parts/Series.js", [F["parts/Globals.js"]], function(a) {
        ...
        a.Series = a.seriesType("line", null, {
                ...
                if (!J) {
                    ...
                    if (w && r > w) {
                        ...
                        for (f = 0; f < r; f++) void 0 !== b[f] && (z = {
                            series: n
                        }, n.pointClass.prototype.applyOptions.apply(z, [b[f]]), n.updateParallelArrays(z, f));
            ...
            drawPoints: function() {
                ...
                e = this.xAxis;
                var w, B = c(l.enabled, !e || e.isRadial ? !0 : null, this.closestPointRangePx >= l.enabledThreshold * l.radius);
    ...
    K(F, "parts/BarSeries.js", [F["parts/Globals.js"]],
        function(a) {
            a = a.seriesType;
            a("bar", "column", null, {
                inverted: !0
    ...
    K(F, "masters/highcharts.src.js", [F["parts/Globals.js"]],
        function(a) {
            return a
        });
